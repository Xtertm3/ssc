export const privacyPolicy = {
  ...
  content: `
    ...
    <p>The terms "We" / "Us" / "Our"/"Company" individually and collectively refer to Sri Shakambari Chits Pvt Ltd and the terms "You" /"Your" / "Yourself" refer to the users.</p>
    ...
    <p>This Privacy Policy is a legally binding document between you and Sri Shakambari Chits Pvt Ltd (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and Sri Shakambari Chits Pvt Ltd for your use of the website "Website" (defined below).</p>
    ...
    <p><strong>Redressal Mechanism:</strong> Any complaints, abuse or concerns with regards to content and or comment or breach of these terms shall be immediately informed to the designated Grievance Officer as mentioned below via in writing or through email signed with the electronic signature.</p>
    
    <p><strong>Mr Srinivas.R (Grievance Officer)</strong><br>
    www.srishakambarichits.com<br>
    Sri Shakambari Chits Pvt Ltd<br>
    #75, Banashankari Market, Avenue Road Cross,<br>
    Jumma Masjid Road, Bengaluru-560 002<br>
    Email: srinivas.r@srishakambarichits.com<br>
    Ph: 9986277180</p>
  `
}
...
export const termsAndConditions = {
  ...
  content: `
    <p>Your website may use the Terms and Conditions given below.</p>
    
    <p>The terms "We" / "Us" / "Our"/"Company" individually and collectively refer to Sri Shakambari Chits Pvt Ltd and the terms "Visitor" "User" refer to the users.</p>
